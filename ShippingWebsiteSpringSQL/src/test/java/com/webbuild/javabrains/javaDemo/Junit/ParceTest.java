...
class ParceTest {
	...
	@Test
	void dynamicparsetest_Priority1error() {
		//Given
		String sample="monkey pickel pie";
		//When
		String[] tstarray= SimpleSerch.dynamicparse(sample);
		//Then
		assertThat("ErrCollume", is(tstarray[0]));
	...
	@Test
	void dynamicparsetest_Priority2error() {
		//Given
		String sample="median pickel pie";
		//When
		String[] tstarray= SimpleSerch.dynamicparse(sample);
		//Then
		assertThat("ErrCompair", is(tstarray[0]));
	...
	@Test
	void dynamicparsetest_Priority3error() {
		//Given
		String sample="min contains pie";
		//When
		String[] tstarray= SimpleSerch.dynamicparse(sample);
		//Then
		assertThat("ErrOrder", is(tstarray[0]));
